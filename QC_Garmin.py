...
data_dir = 'Q:/Data/BRC_Projects/PP04_Thyroid/_analysis/rename_unzip_garmin/_toUpload'               # Location of renamed folders, with the renamed garmin data in.
output_QC = 'Q:/Data/BRC_Projects/PP04_Thyroid/_analysis/QC_Garmin/qc_output'              # Location where QC log and graphs will be saved
# Files to QC:
heartrate = '*heartrate*'
